document.addEventListener("DOMContentLoaded", () => {
    ...
    const openModal = (title, description, card) => {
        ...
        // Position the modal relative to the card
        modal.style.position = 'absolute';
        modal.style.top = `${window.scrollY + cardRect.top}px`;
        modal.style.left = `${window.scrollX + cardRect.left}px`;
    ...
    document.querySelectorAll(".project-link").forEach(link => {
        link.addEventListener("click", e => {
            e.preventDefault();
            const card = link.closest(".card"); // Get the clicked card
